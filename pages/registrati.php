...
<body class="bg-body-pagine">
    <nav class="navbar navbar-expand bg-black">
        <div class="container-fluid">
            <img src="../images/f1_logo_footer.svg" alt="Logo" width="100" height="90"
    ...
    <div class="row">
        ...
        <div class="container col-9 text-start">
            ...
            <form action="controlloRegistrazione.php" method="POST">
                ...
                <input type="text" name="nome" class="border-2 border-black rounded-2 col-9 height_input"
                    placeholder="Inserisci nome" required><br><br>
                <label for="cognome">Cognome:</label><br>
                <input type="text" name="cognome" class="border-2 border-black rounded-2 col-9 height_input"
                    placeholder="Inserisci cognome" required><br><br>
                <label for="nazione">Nazionalità:</label><br>
                <input type="text" name="nazione" class="border-2 border-black rounded-2 col-9 height_input"
                    placeholder="Inserisci la tua nazionalità" required><br><br>
                ...
                <input type="email" name="email" class="border-2 border-black rounded-2 col-9 height_input"
                    placeholder="Inserisci email" required><br><br>
                <label for="password">Password:</label><br>
                <input type="password" name="password" class="border-2 border-black rounded-2 col-9 height_input"
                    placeholder="Inserisci password" required><br><br>
                <input type="submit" class="bg-danger text-white rounded px-3 py-2 border border-danger"
                    value="Registrati">
            </form><br><br>
            <span>Hai già effettuato l'accesso? <a href="./accedi.php"
                    class="link-opacity-50-hover link-underline-danger link-offset-2 visited text-black">Accedi</a></span>
        </div>
    </div><br><br>
