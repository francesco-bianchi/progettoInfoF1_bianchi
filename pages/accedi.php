...
<body class="bg-body-pagine">
    ...
    <?php
		if(isset($_GET["negato"])){
			$message = "Password non corretta o account inesistente";
    ...
    <div class="row">
        ...
        <div class="container col-9 text-start">
            <h4 class="border_accesso col-9">Accedi al team di Formula1</h4>
            ...
            <span>Non hai ancora effettuato l'accesso? <a href="./registrati.php"
                    class="link-opacity-50-hover link-underline-danger link-offset-2 visited text-black">Registrati</a></span>
        </div>
    </div>
